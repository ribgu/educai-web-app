...
export default function MainTextLogo() {
    return (
        <div className='flex flex-col items-center text-white gap-y-8'>
            <Typography variant='lp-title'>CHANGING THE <br />
                ...
                <span className='bg-gradient-to-b from-violet-900 to-violet-500 text-transparent bg-clip-text'> LEAR</span>
            </Typography>
